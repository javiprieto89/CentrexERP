...
from app.crud.tmpcobros_retenciones import create_tmpcobro_retencion, update_tmpcobro_retencion, delete_tmpcobro_retencion
...
class TmpCobroRetencionMutations:
    ...
    def delete_tmp_cobro_retencion(self, id_tmpCobroRetencion: int) -> bool:
        db = SessionLocal()
        result = delete_tmpcobro_retencion(db, id_tmpCobroRetencion)
        db.close()
        return result